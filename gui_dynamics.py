...
class RPRRDynamicsSimulator:
    ...
    def setup_gui(self):
        ...
        gs = gridspec.GridSpec(3, 4, figure=self.fig,
                              left=0.03, right=0.97, top=0.93, bottom=0.38,
    ...
    def setup_controls(self):
        ...
        # Headers
        self.fig.text(col1_x + 0.08, y_base + 0.06, 'POSITION q', 
                     ha='center', fontsize=12, fontweight='bold', color='#e94560')
        self.fig.text(col2_x + 0.08, y_base + 0.06, 'VELOCITY q̇', 
                     ha='center', fontsize=12, fontweight='bold', color='#00ff88')
        self.fig.text(col3_x + 0.08, y_base + 0.06, 'ACCELERATION q̈', 
                     ha='center', fontsize=12, fontweight='bold', color='#ffd700')
        self.fig.text(col4_x + 0.08, y_base + 0.06, 'PRESETS', 
